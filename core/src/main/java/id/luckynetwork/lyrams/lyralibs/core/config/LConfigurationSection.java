...
public interface LConfigurationSection {

    /**
     * Gets a set containing all keys in this section.
     * <p>
     * If deep is set to true, then this will contain all the keys within any
     * child {@link LConfigurationSection}s (and their children, etc). These
     ...
     *             list.
     * @return Set of keys contained within this LConfigurationSection.
     */
    @NotNull
     ...
     * within any child {@link LConfigurationSection}s (and their children,
    ...
    /**
     * Gets the path of this {@link LConfigurationSection} from its root {@link
     * LConfiguration}
     * <p>
     * For any {@link LConfiguration} themselves, this will return an empty
     * string.
     * <p>
    ...
    /**
     * Gets the name of this individual {@link LConfigurationSection}, in the
     * path.
     * <p>
    ...
    /**
     * Gets the root {@link LConfiguration} that contains this {@link
     * LConfigurationSection}
     * <p>
     * For any {@link LConfiguration} themselves, this will return its own
     * object.
     * <p>
     * If the section is no longer contained within its root for any reason,
     * such as being replaced with a different value, this may return null.
     *
     * @return Root LConfiguration containing this section.
     */
    @Nullable
    LConfiguration getRoot();

    /**
     * Gets the parent {@link LConfigurationSection} that directly contains
     * this {@link LConfigurationSection}.
     * <p>
     * For any {@link LConfiguration} themselves, this will return null.
     * <p>
     ...
     */
    @Nullable
    LConfigurationSection getParent();

    /**
     * Gets the equivalent {@link LConfigurationSection} from the default
     * {@link LConfiguration} defined in {@link #getRoot()}.
     * <p>
     * If the root contains no defaults, or the defaults doesn't contain a
     * value for this path, or the value at this path is not a {@link
     * LConfigurationSection} then this will return null.
     *
     * @return Equivalent section in root LConfiguration
     */
    @Nullable
    LConfigurationSection getDefaultSection();
    ...
    /**
     * Creates an empty {@link LConfigurationSection} at the specified path.
     * <p>
     * Any value that was previously set at this path will be overwritten. If
     * the previous value was itself a {@link LConfigurationSection}, it will
     * be orphaned.
     *
     ...
     */
    @NotNull
    LConfigurationSection createSection(@NotNull String path);

    /**
     * Creates a {@link LConfigurationSection} at the specified path, with
     * specified values.
     * <p>
     * Any value that was previously set at this path will be overwritten. If
     * the previous value was itself a {@link LConfigurationSection}, it will
     ...
     */
    @NotNull
    LConfigurationSection createSection(@NotNull String path, @NotNull Map<?, ?> map);

    /**
     * Checks if this {@link LConfigurationSection} has a value set for the
     * given path.
     * <p>
     ...
     * you to store {@link LConfiguration}s or {@link LConfigurationSection}s,
    ...
    /**
     * Checks if this {@link LConfigurationSection} contains the given path.
     * <p>
     * If the value for the requested path does not exist but a default value
    ...
    /**
     * Checks if the specified path is a LConfigurationSection.
     * <p>
     * If the path exists but is not a LConfigurationSection, this will return
     * false. If the path does not exist, this will return false. If the path
     * does not exist but a default value has been specified, this will check
     * if that default value is a LConfigurationSection and return
     * appropriately.
     *
     * @param path Path of the LConfigurationSection to check.
     * @return Whether or not the specified path is a LConfigurationSection.
     */
    boolean isConfigurationSection(@NotNull String path);

    /**
     * Gets the requested LConfigurationSection by path.
     * <p>
     * If the LConfigurationSection does not exist but a default value has been
     * specified, this will return the default value. If the
     * LConfigurationSection does not exist and no default value was specified,
     * this will return null.
     *
     * @param path Path of the LConfigurationSection to get.
     * @return Requested LConfigurationSection.
     */
    @Nullable
    LConfigurationSection getConfigurationSection(@NotNull String path);
     ...
     */
    @NotNull
    List<String> getStringList(@NotNull String path, @Nullable List<String> def);
