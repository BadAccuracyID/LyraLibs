...
public class QueryBuilder {
    ...
    /**
     * replaces every '?' in the query with the replacements sequentially
     *
     * @param replacements the replacements
     * @return the query with every '?' replaced with its replacements sequentially
     */
            ...
            if (c == '?') {
                ...
                for (Object replacement : replacements) {
                    if (j == i) {
                        ...
                        if (this.isNotText(replacement.toString())) {
    ...
    private boolean isNotText(String s) {
        try {
            if (s.equals("")) {
                return false;
            }
